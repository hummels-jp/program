...
#include <regex>
#ifdef _WIN32
#include "dirent.h" // Use a custom implementation of dirent.h for Windows
#else
#include <dirent.h> // Use the standard dirent.h for POSIX systems
#endif
#include <cstdlib>
#include <string.h>
#include <sstream>
